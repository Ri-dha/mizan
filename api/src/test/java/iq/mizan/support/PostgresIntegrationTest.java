...
public abstract class PostgresIntegrationTest {
    ...
    protected void resetTransactionalData() {
        jdbcTemplate.execute("truncate table goal_deposit, goal, debt_payment, debt, attachment, ledger_transaction, expense_occurrence, recurring_expense, bucket, plan, income_receipt, income_source, cash_account, sync_conflict, sync_op_receipt, sync_log, "
